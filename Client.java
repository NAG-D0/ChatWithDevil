...
public class Client implements ActionListener{
	...
	Client(){
			...
			ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("profiles/darl1.png"));
			...
			JLabel name1=new JLabel("❤️");
			name.setBounds(110,18,100,25);
			name1.setBounds(160,18,100,25);
